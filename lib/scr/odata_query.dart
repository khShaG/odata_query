...
class Filter {
  ...
  static Filter and(Filter left, Filter right) => Filter._('${left.expression} and ${right.expression}');

  /// Combines two filters using a logical OR (e.g., "Name eq 'Milk' or Price lt 2.55").
  static Filter or(Filter left, Filter right) => Filter._('${left.expression} or ${right.expression}');
